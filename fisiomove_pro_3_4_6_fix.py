# Fisiomove Pro 3.4.6 (fix)
# - Fix StreamlitDuplicateElementKey
# - Theme blu coerente col logo
# - Compatibile con Streamlit >= 1.39 (st.image(..., use_container_width=True))
# - Radar, barre simmetria, PDF con logo, autosave/autoload, reset sezione, Valutazione Generale
...
def radar_png_buffer(labels, scores):
    ...
    ax.fill(angles_c, scores_c, color="#1E6CF444")
